...
// Flow 
// Mount -> Intro Speak -> Question Speak -> Mic on -> Timer Running -> Submit
...
function Step2Interview({interviewData, onFinish}) {
  ...
  const SpeakText = (text) => {
    return new Promise((resolve) => {
      ...
      // Human like pacing
      utterance.rate = 0.93  // Slightly slower than normal
  ...
  useEffect(() => {
    ...
    const runIntro = async() => {
      if(isIntroPhase){
        ...
        await SpeakText(
          "I'll ask you a few questions. Justify answer naturally , and take your time. Let's begin."
        );

        setIsIntroPhase(false);
      } else if(currentQuestion){
        await new Promise(r => setTimeout(r, 800));
        // If the last question(hard level)
 ...
 const handleNext = async() => {
  ...
  }, [timeLeft, isSubmitting, feedback, hasSubmitted]);
      ...
      <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          (<div className='flex items-center gap-4 mt-6'>
              ...
              whileTap={{scale:0.9}}
              className='flex-1 disabled:bg-gray-500 bg-linear-to-r from-emerald-600 to-teal-500 text-white py-3 sm:py-4 rounded-2xl shadow-lg hover:opacity-90 transition font-semibold'> 
            ...
            <button 
            onClick={handleNext}
            className='w-full flex items-center justify-center gap-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition'>
